...
def mcp_find_object_profile(object_name):
    ...
    raise ValueError(
        ...
        "Use cube, medicine, nut, pipe, sponge, black marker, blue marker, green marker, yellow marker, red marker, marker, screwdriver, or unknown_blocker."
    )
